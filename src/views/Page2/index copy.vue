<template>
  <div class="layout-container">
    ...
    <div class="left-side">
      <div
        class="left-parent-item container"
        ...
        <div class="content">
          <template v-if="item.children && item.children.length > 0">
            <div
              ...
              class="left-item"
              :class="{
                'left-item-active': index === currentActive,
                'left-item-default': index !== currentActive,
              }"
            >
              {{ child.name }}
    ...
    <div class="right-side">
      <div
        class="right-item"
        :class="{
          'right-item-active': index === currentActive,
          'right-item-default': index !== currentActive,
        }"
    ...
    return {
      ...
      rightItems: [
        ...
        },
        {
          id: 5,
          name: "合同管理",
          icon: require("@/assets/images/page2/l5.png"),
        },
        {
          id: 6,
          name: "财务系统",
          icon: require("@/assets/images/page2/l6.png"),
        },
        {
          id: 7,
          name: "任务管理",
          icon: require("@/assets/images/page2/l7.png"),
        },
        {
          id: 8,
          name: "文档系统",
          icon: require("@/assets/images/page2/l8.png"),
        },
        {
          id: 11,
          name: "数字看板",
          icon: require("@/assets/images/page2/r3.png"),
        },
        {
          id: 12,
          name: "产品溯源",
          icon: require("@/assets/images/page2/r4.png"),
        },
        {
          id: 13,
          name: "能耗管理",
          icon: require("@/assets/images/page2/r5.png"),
        },
        { id: 14, name: "QMS", icon: require("@/assets/images/page2/r6.png") },
        {
          id: 16,
          name: "采购管理",
          icon: require("@/assets/images/page2/r8.png"),
        },
      ],
      // 默认选中的选项
      selectedItem: {
      ...
      centralContent: [
        ...
        },
        {
          name: "合同管理系统概述",
          description:
            "合同管理是指利用数字化工具和技术来创建、存储、追踪、分析和执行合同的全过程。它旨在提高合同管理的效率、透明度和合规性，从而优化企业的运营和风险管理。数字化合同管理使得合同管理更加高效、透明和系统化，减少了手动操作、提高了协作效率，并增强了合同的合规性和风险管理能力。",
          image: require("@/assets/images/page2/center5.png"),
        },
        {
          name: "财务系统系统概述",
          description:
            "财务系统是一种集成的软件解决方案，旨在帮助企业管理和自动化与财务相关的所有功能。这些功能包括预算、会计、财务报表、现金流管理、费用跟踪、资产管理等，以实现高效、准确的财务管理。数字化财务系统的主要优势包括提高运营效率、减少人为错误、增强数据的准确性和安全性、提高透明度和合规性，以及提供更好的财务洞察，从而支持企业的整体战略目标与规划。",
          image: require("@/assets/images/page2/center6.png"),
        },
        {
          name: "任务管理系统概述",
          description:
            "任务管理是指利用软件工具和技术来规划、追踪、组织和执行任务的过程。它旨在提高团队的协作效率、工作透明度和项目管理能力。任务管理系统通常用于日常工作、项目管理和团队协作，能够帮助用户更好地分配资源、优化时间管理，并确保任务按时完成。任务管理系统的优势包括提高工作效率、减少沟通障碍、提升团队协调能力，以及增强项目管理的可视性和控制力。团队可以更有条理地完成任务，推动项目成功。",
          image: require("@/assets/images/page2/center7.png"),
        },
        {
          name: "文档系统概述",
          description:
            "文档系统（Document Management System，DMS）是指用于创建、存储、管理和追踪电子文档及其相关信息的软件系统。文档系统旨在提高文档的存取、组织和安全性，提供便捷的文档共享与协作功能，从而增强企业的工作效率、合规性和信息管理能力。数字化文档系统的优势包括提升文档管理的效率，降低纸质文档的使用，改善信息的可访问性与安全性，以及增强团队的协作能力。企业能够更有效地管理和利用其文档资源。",
          image: require("@/assets/images/page2/center8.png"),
        },
        {
          name: "采购管理系统概述",
          description:
            "采购管理指的是利用数字化工具和技术来规划、执行和监控采购活动的过程。这包括从供应商选择、合同管理到采购订单处理和付款的整个流程。数字化采购管理旨在提高采购效率、降低成本、增强透明度和合规性，从而优化企业的供应链管理。数字化采购管理的优势包括提高采购流程的效率和准确性、降低操作成本、增强透明度、提高供应商管理的有效性和确保合规性。可以帮助企业优化采购流程，提升整体供应链的绩效。",
        ...
        },
        {
          name: "数字看板概述",
          description:
            "数字看板（Digital Dashboard）是一种可视化工具，用于呈现关键绩效指标（KPI）和实时数据，帮助企业和团队快速了解业务状况、执行情况和目标达成程度。数字看板将大量的数据和信息以图形化、简洁的方式展示，使用户能够一目了然地把握关键指标和趋势，从而支持快速决策和行动。数字看板的优势包括提高决策效率、增强运营透明度、改进数据可视化、促进团队协作等。通过实施数字看板，企业能够更好地监控业务健康状况，迅速作出反应，从而提升竞争力和适应市场变化的能力。",
          image: require("@/assets/images/page2/center12.png"),
        },
        {
          name: "产品溯源系统概述",
          description:
            "产品溯源（Product Traceability）是指通过信息技术和系统，跟踪和记录产品从原材料到最终用户的整个生命周期的过程。产品溯源能够确保产品在生产、运输、销售和使用过程中每个环节的信息都可以被准确记录和追踪。这种能力对于确保产品质量、安全性和合规性非常重要。产品溯源的优势包括提升产品质量管理、增强透明度、提高消费者信任、促进合规性审计以及提高供应链效率。在数字化转型的背景下，企业越来越依赖物联网（IoT）、区块链、云计算和大数据等技术来实现智能化的产品溯源管理。这些技术能够大大改善数据的采集和分析能力，提高溯源过程的效率和准确性。",
          image: require("@/assets/images/page2/center13.png"),
        },
        {
          name: "能耗管理系统概述",
          description:
            "能耗管理（Energy Management）是指通过监测、分析和优化能源使用，以提高能源效率、降低能源成本、减少环境影响的一系列活动和策略。能耗管理利用数字化技术和智能系统，帮助企业和组织实现对能源使用的实时可视化和管理，从而促进可持续发展。能耗管理的优势包括降低运营成本、提高能源使用效率、减少碳排放、支持可持续发展目标、增强企业的社会责任感等。随着数字化技术的不断发展，越来越多的企业采用智能电表、能源管理系统（EMS）和云计算等工具，来实现更高效、更动态的能耗管理，以满足日益增长的环境保护和能源节约要求。",
          image: require("@/assets/images/page2/center14.png"),
        },
        {
          name: "QMS系统概述",
          description:
            "QMS（质量管理系统，Quality Management System）是一套用于定义、控制和改进产品或服务质量的框架。QMS帮助企业确保其产品或服务符合客户期望、行业标准和法规要求。通过实施质量管理系统，企业可以实现持续改进、减少浪费、优化资源利用，从而提高竞争力。数字化QMS系统的优势包括增强质量控制和追踪能力、提高合规性、降低质量成本、促进数据驱动的决策，以及增强客户满意度。企业通过QMS系统可以更好地满足客户的高质量要求，并在激烈的市场竞争中保持优势。",
